...
type TriggerConfigRequestBody = {
    workflowId?: string;
    type: string;
    config: object;
    nodeId?: string;
}
export const createTriggerConfig: RequestHandler = async (req, res) => {
    try {
        ...
        const data: TriggerConfigRequestBody = {
            workflowId,
            type,
            config,
            nodeId
...
export const getTriggerConfig:RequestHandler=async(req,res)=>{
    try {
...
export const updateTriggerConfig:RequestHandler=async(req,res)=>{
    try {
...
export const deleteTriggerConfig:RequestHandler=async(req,res)=>{
    try {
